    ...
    <div className="space-y-6 sm:space-y-8 px-4 sm:px-0">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="w-full px-3 sm:px-4 py-2.5 sm:py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm sm:text-base"
            ...
            <div className="flex gap-2">
              <select
                ...
                className="flex-1 sm:flex-none px-3 sm:px-4 py-2.5 sm:py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 text-sm sm:text-base"
                disabled={!apiKey || isSearching}
              >
              ...
              <button
                ...
                disabled={!apiKey || isSearching}
                className="flex-1 sm:flex-none px-4 sm:px-6 py-2.5 sm:py-2 bg-red-600 text-white rounded-md hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors whitespace-nowrap text-sm sm:text-base font-medium"
              >
                {isSearching ? '검색 중...' : '검색'}
              </button>
            </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="w-full px-3 sm:px-4 py-2.5 sm:py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
              disabled={!apiKey || isSearching}
              onKeyPress={(e) => {
                if (e.key === 'Enter') {
            ...
            <div className="flex gap-2">
              <select
                ...
                className="flex-1 sm:flex-none px-3 sm:px-4 py-2.5 sm:py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
                disabled={!apiKey || isSearching}
              >
                <option value={50}>50개</option>
                <option value={100}>100개</option>
              ...
              <button
                ...
                disabled={!apiKey || isSearching}
                className="flex-1 sm:flex-none px-4 sm:px-6 py-2.5 sm:py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors whitespace-nowrap text-sm sm:text-base font-medium"
              >
                {isSearching ? '검색 중...' : '검색'}
              </button>
            </div>
      ...
      {isSearching && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
          <div className="text-blue-700 font-semibold text-sm sm:text-base">검색 중입니다...</div>
